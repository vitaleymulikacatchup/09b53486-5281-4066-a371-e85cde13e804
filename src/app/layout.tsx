...
export const metadata: Metadata = {
  title: "SmileCare Dental - Quality Dental Care for the Whole Family",
  description: "Comprehensive dental services including general dentistry, cosmetics, orthodontics, and oral surgery. Advanced technology with compassionate care in a modern facility.",
  keywords: "dental clinic, dentist, dental care, teeth cleaning, cosmetic dentistry, orthodontics, oral surgery, family dentistry",
  metadataBase: new URL("https://smilecare-dental.com"),
  alternates: {
    canonical: "https://smilecare-dental.com"
  },
  openGraph: {
    title: "SmileCare Dental - Quality Dental Care",
    description: "Professional dental services with advanced technology and compassionate care for the whole family",
    siteName: "SmileCare Dental",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763652589574-44cpg2fa.jpg",
        alt: "SmileCare Dental modern clinic interior"
      }
    ]
  },
  twitter: {
    ...
    title: "SmileCare Dental - Quality Dental Care",
    description: "Professional dental services with advanced technology and compassionate care",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763652589574-44cpg2fa.jpg"]
  },
  robots: {
    index: true,
    follow: true
